...
declare global {
  ...
  type Prettify<T> = [T] extends [infer U]
    ? { [K in ObjectPropertyKey<U>]: ObjectPropertyValue<U, K> }
    : never;
  ...
  type ArrayInnerPair<
    T extends Array<any>,
    U extends ObjectPropertyKey<ArrayInnerType<T>> = ObjectPropertyKey<ArrayInnerType<T>>,
    P extends ObjectPropertyKey<ArrayInnerType<T>> = ObjectPropertyKey<ArrayInnerType<T>>
  > = Record<
    [ObjectPropertyValue<ArrayInnerType<T>, U>] extends [PropertyKey]
      ? ObjectPropertyValue<ArrayInnerType<T>, U>
      : never,
    ObjectPropertyValue<ArrayInnerType<T>, P>
  >;
   ...
   */
  type PromiseReturnType<T extends (...rest: any[]) => any> = [ReturnType<T>] extends [
    Promise<infer R>
  ]
    ? R
    : ReturnType<T>;
   ...
   * example: PromisePrettifyReturnType<(...rest: any[]) => Promise<{a: string}[]>> => {a: string}
   */
  type PromisePrettifyReturnType<T extends (...rest: any[]) => any> = [
    PromiseReturnType<T>
  ] extends [Array<any>]
    ? ArrayInnerType<PromiseReturnType<T>>
    : PromiseReturnType<T>;
   ...
   * example: PromiseSelectReturnType<(...rest: any[]) => Promise<{a: string}[]>, 'a'> => string
   */
  type PromiseSelectReturnType<
    T extends (...rest: any[]) => any,
    U extends ObjectPropertyKey<PromisePrettifyReturnType<T>> = never
  > = [U] extends [never]
    ? PromisePrettifyReturnType<T>
    : ObjectPropertyValue<PromisePrettifyReturnType<T>, U> /* <PromisePrettifyReturnType<T>[U] */;
   ...
   */
  type PromisePickReturnType<
    T extends (...rest: any[]) => any,
    U extends ObjectPropertyKey<PromisePrettifyReturnType<T>> = never
  > = [U] extends [never] ? PromisePrettifyReturnType<T> : Pick<PromisePrettifyReturnType<T>, U>;
   ...
   * example: PromiseOmitReturnType<(...rest: any[]) => Promise<{a: string, b: number}[]>, 'a'> => {b: number}
   */
  type PromiseOmitReturnType<
    T extends (...rest: any[]) => any,
    U extends ObjectPropertyKey<PromisePrettifyReturnType<T>> = never
  > = [U] extends [never] ? PromisePrettifyReturnType<T> : Omit<PromisePrettifyReturnType<T>, U>;
   ...
   * example: PromiseArrayOuterReturnType<(...rest: any[]) => Promise<{a: string[]}[], 'a'>> => string[]
   */
  type PromiseArrayOuterReturnType<
    T extends (...rest: any[]) => any,
    U extends ObjectPropertyKey<PromisePrettifyReturnType<T>> = never
  > = Array<PromiseSelectReturnType<T, U>>;
   ...
   */
  type PromiseArrayInnerReturnType<
    T extends (...rest: any[]) => any,
    U extends ObjectPropertyKey<PromisePrettifyReturnType<T>> = never
  > = ArrayInnerType<PromiseSelectReturnType<T, U>>;
