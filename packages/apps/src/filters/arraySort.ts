...
export function arraySort<T extends ArrayItemType>(sourceData: T[], attr: string, rev = 1): T[] {
  return Array.prototype.sort.call(deepCopy(sourceData), (a: T, b: T) => {
    let old: any = a,
      cur: any = b;
...
export default {
  install: (app: App): void => {
    ...
    app.config.globalProperties.$filters = Object.assign(Object.create(null), filters, {
      [hyphenate(arraySort.name)]: arraySort,
    });
  },
};
